...
describe('Address e2e test', () => {
  ...
  const addressSample = { address1: 'fantastic', city: 'Beavercreek', state: 'pretty', zipCode: '33448' };
  ...
  describe('new Address page', () => {
    ...
    it('should create an instance of Address', () => {
      cy.get(`[data-cy="address1"]`).type('battleship um');
      cy.get(`[data-cy="address1"]`).should('have.value', 'battleship um');

      cy.get(`[data-cy="address2"]`).type('reheat ugh');
      cy.get(`[data-cy="address2"]`).should('have.value', 'reheat ugh');

      cy.get(`[data-cy="city"]`).type('Johnfield');
      cy.get(`[data-cy="city"]`).should('have.value', 'Johnfield');

      cy.get(`[data-cy="state"]`).type('debar');
      cy.get(`[data-cy="state"]`).should('have.value', 'debar');

      cy.get(`[data-cy="county"]`).type('boogie');
      cy.get(`[data-cy="county"]`).should('have.value', 'boogie');

      cy.get(`[data-cy="zipCode"]`).type('40309');
      cy.get(`[data-cy="zipCode"]`).should('have.value', '40309');

      cy.get(`[data-cy="country"]`).type('French Southern Territories');
      cy.get(`[data-cy="country"]`).should('have.value', 'French Southern Territories');
