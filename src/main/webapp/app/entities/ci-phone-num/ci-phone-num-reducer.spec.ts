...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CIPHONENUM_LIST actions', async () => {
    ...
    it('dispatches FETCH_CIPHONENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CIPHONENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CIPHONENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CIPHONENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CIPHONENUM actions', async () => {
      const expectedActions = [
        {
