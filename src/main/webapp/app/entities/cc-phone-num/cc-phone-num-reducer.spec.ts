...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CCPHONENUM_LIST actions', async () => {
    ...
    it('dispatches FETCH_CCPHONENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CCPHONENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CCPHONENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CCPHONENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CCPHONENUM actions', async () => {
      const expectedActions = [
        {
