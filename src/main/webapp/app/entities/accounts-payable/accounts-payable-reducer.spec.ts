...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCOUNTSPAYABLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACCOUNTSPAYABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCOUNTSPAYABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCOUNTSPAYABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCOUNTSPAYABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCOUNTSPAYABLE actions', async () => {
      const expectedActions = [
        {
