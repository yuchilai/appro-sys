...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CCADDRESS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CCADDRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CCADDRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CCADDRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CCADDRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CCADDRESS actions', async () => {
      const expectedActions = [
        {
