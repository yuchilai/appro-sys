...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cc-email.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CCEMAIL_LIST actions', async () => {
    ...
    it('dispatches FETCH_CCEMAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CCEMAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CCEMAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CCEMAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CCEMAIL actions', async () => {
      const expectedActions = [
        {
