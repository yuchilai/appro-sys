...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './email.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMAIL_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMAIL actions', async () => {
      const expectedActions = [
        {
