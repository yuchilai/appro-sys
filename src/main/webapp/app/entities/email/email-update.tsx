...
export const EmailUpdate = () => {
  ...
  const updating = useAppSelector(state => state.email.updating);
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...emailEntity,
          applicationUser: emailEntity?.applicationUser?.id,
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="approSysApp.email.home.createOrEditLabel" data-cy="EmailCreateUpdateHeading">
            <Translate contentKey="approSysApp.email.home.createOrEditLabel">Create or edit a Email</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('approSysApp.email.email')}
                id="email-email"
                name="email"
                data-cy="email"
                type="text"
              ...
              />
              <ValidatedField
                id="email-applicationUser"
                name="applicationUser"
                data-cy="applicationUser"
                label={translate('approSysApp.email.applicationUser')}
                type="select"
              >
                <option value="" key="0" />
                {applicationUsers
              ...
              <Button tag={Link} id="cancel-save" data-cy="entityCreateCancelButton" to="/email" replace color="info">
