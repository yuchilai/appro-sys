...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './approver.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPROVER_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPROVER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPROVER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPROVER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPROVER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPROVER actions', async () => {
      const expectedActions = [
        {
