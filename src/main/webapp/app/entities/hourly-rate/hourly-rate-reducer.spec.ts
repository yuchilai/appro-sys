...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HOURLYRATE_LIST actions', async () => {
    ...
    it('dispatches FETCH_HOURLYRATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HOURLYRATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HOURLYRATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HOURLYRATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HOURLYRATE actions', async () => {
      const expectedActions = [
        {
