...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLIENTCOMPANY_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLIENTCOMPANY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLIENTCOMPANY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLIENTCOMPANY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLIENTCOMPANY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLIENTCOMPANY actions', async () => {
      const expectedActions = [
        {
