...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTSERVICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROJECTSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJECTSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJECTSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJECTSERVICE actions', async () => {
      const expectedActions = [
        {
