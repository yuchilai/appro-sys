...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './invoice-billing-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVOICEBILLINGINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_INVOICEBILLINGINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INVOICEBILLINGINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INVOICEBILLINGINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INVOICEBILLINGINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INVOICEBILLINGINFO actions', async () => {
      const expectedActions = [
        {
