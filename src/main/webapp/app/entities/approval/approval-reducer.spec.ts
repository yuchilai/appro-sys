...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './approval.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPROVAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPROVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPROVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPROVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPROVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPROVAL actions', async () => {
      const expectedActions = [
        {
