...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKENTRY_LIST actions', async () => {
    ...
    it('dispatches FETCH_WORKENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKENTRY actions', async () => {
      const expectedActions = [
        {
