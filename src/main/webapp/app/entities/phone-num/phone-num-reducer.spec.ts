...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './phone-num.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PHONENUM_LIST actions', async () => {
    ...
    it('dispatches FETCH_PHONENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PHONENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PHONENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PHONENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PHONENUM actions', async () => {
      const expectedActions = [
        {
