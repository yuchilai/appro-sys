...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTACTINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTACTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTACTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTACTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTACTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTACTINFO actions', async () => {
      const expectedActions = [
        {
