...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CIADDRESS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CIADDRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CIADDRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CIADDRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CIADDRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CIADDRESS actions', async () => {
      const expectedActions = [
        {
