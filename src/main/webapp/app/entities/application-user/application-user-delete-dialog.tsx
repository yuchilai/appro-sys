...
export const ApplicationUserDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="approSysApp.applicationUser.delete.question">
        <Translate contentKey="approSysApp.applicationUser.delete.question" interpolate={{ id: applicationUserEntity.id }}>
