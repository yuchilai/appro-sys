...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ci-email.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CIEMAIL_LIST actions', async () => {
    ...
    it('dispatches FETCH_CIEMAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CIEMAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CIEMAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CIEMAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CIEMAIL actions', async () => {
      const expectedActions = [
        {
